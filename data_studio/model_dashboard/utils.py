...
def get_readme(dataset_obj):
    if os.path.isfile(os.path.join(dataset_obj.dataset_path,"README.md")):
        with open(os.path.join(dataset_obj.dataset_path,"README.md")) as f:
